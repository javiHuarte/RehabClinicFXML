...
public class Department implements Serializable {
	...
	public Department(Integer id, String name, int floor, float budget) {
		super();
		this.id = id;
		this.name = name;
		this.floor = floor;
	...
	public String toString() {
		return "Department [id=" + id + ", name=" + name + ", floor=" + floor + ", budget=" + budget + ", staffList="
				+ staffList + ", medicalProfessionalList=" + medicalProfessionalList + "]";
	}
